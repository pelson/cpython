...
class SizeofTest(unittest.TestCase):
    ...
    def test_objecttypes(self):
        ...
        # BaseException (gh-116862: + traceback_history pointer +
        # user_defined_traceback byte)
        check(BaseException(), size('7Pbb'))
        # UnicodeEncodeError
        check(UnicodeEncodeError("", "", 0, 0, ""), size('7Pbb 2P2nP'))
        # UnicodeDecodeError
        check(UnicodeDecodeError("", b"", 0, 0, ""), size('7Pbb 2P2nP'))
        # UnicodeTranslateError
        check(UnicodeTranslateError("", 0, 1, ""), size('7Pbb 2P2nP'))
        # ellipses
        check(Ellipsis, size(''))
        # EncodingMap
